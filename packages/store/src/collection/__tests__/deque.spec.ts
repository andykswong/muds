...
describe('ArrayDeque', () => {
  ...
  test('first, last, shift(), pop() should return undefined for empty container', () => {
    const deque = new ArrayDeque<string>();
  ...
  test('foreach() should loop through all id-values', () => {
    ...
    deque.forEach((value, id) => results.push([id, value]));
